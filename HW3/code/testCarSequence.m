...
for i = 1:frame_num - 1
    ...
    imshow(frames(:,:,i));
    hold on;
    line(corner_points(1,1:2),corner_points(2,1:2), 'Color','r','LineWidth',1);
    line(corner_points(1,2:3),corner_points(2,2:3), 'Color','r','LineWidth',1);
    line(corner_points(1,3:4),corner_points(2,3:4), 'Color','r','LineWidth',1);
    line([corner_points(1,4);corner_points(1,1)],[corner_points(2,4);corner_points(2,1)], 'Color','r','LineWidth',1);
    hold off;
    pause(0.02);
